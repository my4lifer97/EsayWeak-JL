...
// The business no longer manually marks an appointment "Completed" — once its end time has
...
public static class AppointmentStatusHelper
{
    public static string EffectiveStatus(AppointmentStatus status, DateTime date, string endTime)
    {
        ...
        // EndTime ("17:30") is the business's local wall-clock hour, never converted to/from
