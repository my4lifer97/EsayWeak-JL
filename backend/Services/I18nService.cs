...
public static class I18nService
{
    private static readonly Dictionary<string, Dictionary<string, string>> Messages = new()
    {
        ["EN"] = new()
        {
            ...
            ["whatsapp.modeGate"] = "Hi! I'm {businessName}'s assistant. What would you like to do?\n\n1. Book a service\n2. Ask a question / talk to us\n\nReply with the number.",
            ["whatsapp.modeGatePrompt"] = "What would you like to do?\n\n1. Book a service\n2. Ask a question / talk to us\n\nReply with the number.",
        ...
        ["AR"] = new()
        {
            ...
            ["whatsapp.modeGate"] = "مرحبًا! أنا مساعد {businessName}. ماذا تريد أن تفعل؟\n\n1. حجز خدمة\n2. طرح سؤال / التحدث معنا\n\nأرسل الرقم للاختيار.",
            ["whatsapp.modeGatePrompt"] = "ماذا تريد أن تفعل؟\n\n1. حجز خدمة\n2. طرح سؤال / التحدث معنا\n\nأرسل الرقم للاختيار.",
        ...
        ["HE"] = new()
        {
            ...
            ["whatsapp.modeGate"] = "שלום! אני העוזר של {businessName}. מה תרצה לעשות?\n\n1. לקבוע תור\n2. לשאול שאלה / לדבר איתנו\n\nהשב עם המספר.",
            ["whatsapp.modeGatePrompt"] = "מה תרצה לעשות?\n\n1. לקבוע תור\n2. לשאול שאלה / לדבר איתנו\n\nהשב עם המספר.",
